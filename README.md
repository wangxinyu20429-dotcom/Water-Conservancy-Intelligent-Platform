...
Zotero“科研平台”集合42个唯一来源各有一张独立证据卡，并由主题Skill形成5个候选主题。2026-09-09已按V1.7加深：取得Zotero索引正文的卡片分别交代研究问题、数据构成、独立分析单位、方法链、对照或验证、承重结果与贡献，综述则交代检索范围、证据构成、综合方法和异质性；没有正文的官方网页和题录来源停在材料实际支持的范围。有主文内容的38张卡均达到可见科学正文不少于5,000个非空白字符的门槛（L2卡超过6,000）；折叠校勘与机器字段不计入。全部仍待课题组成员逐表逐图复核，因此候选主题只用于确定精读顺序和补证据任务，不能直接作为论文结论或创新性声明。
