...
> **初读结论：** IPCC第六次评估报告第11章综合观测、归因与投影证据：强降水随增暖增强的证据较强，而河流洪水的区域变化因水文过程、土地利用和水管理更复杂而更不确定。
...
平台需要一个权威基线，区分强降水、地表／山洪与河流洪水，并避免把强降水趋势直接等同于所有河流洪水趋势。
...
报告评估认为，观测较好的多数陆地区域强降水频率和强度可能已增加，人类影响很可能是全球陆地强降水增强的主要驱动。强降水随增暖通常更频繁、更强，约束地表和山洪增加具有高置信度。河流洪水在部分地区已有显著峰值流量趋势，但全球模型对区域变化的不确定性更高，因为土地覆盖与人类水管理等过程参与其中。
...
人工核对执行摘要、11.4、11.5和区域表格的精确措辞与置信度；提取与中国及东亚相关的限定，并记录引用到具体章节。

**候选主题信号：** 气候变化、强降水、地表洪水、河流洪水。这些标签只用于后续聚合，不代表主题已经成立。
